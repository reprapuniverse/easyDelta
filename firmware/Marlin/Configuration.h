...
#define DELTA_SMOOTH_ROD_OFFSET 195 // mm

// Horizontal offset of the universal joints on the end effector.
#define DELTA_EFFECTOR_OFFSET 35 // mm

// Horizontal offset of the universal joints on the carriages.
#define DELTA_CARRIAGE_OFFSET 19 // mm
...
#define MANUAL_Z_HOME_POS 234.5  // For delta: Distance between nozzle and print surface after homing.
